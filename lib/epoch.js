...
exports.timezones[3] = { code: 'AST', momentName: 'US/Alaska', name: 'UTC -9:00 - Alaska Standard Time (AST)', utcOffset: -9, dstStart: new Date(Date.UTC(2016, 2, 13, 2)), dstEnd: new Date(Date.UTC(2016, 10, 6, 2)) };
exports.timezones[4] = { code: 'PST', momentName: 'US/Pacific', name: 'UTC -8:00 - Pacific Standard Time (PST)', utcOffset: -8, dstStart: new Date(Date.UTC(2016, 2, 13, 2)), dstEnd: new Date(Date.UTC(2016, 10, 6, 2)) };
    ...
    if (typeof timezone == 'string') {
        ...
        for (var key in exports.timezones) {
            if (exports.timezones.hasOwnProperty(key)) {
                timezone = exports.timezones[key];
